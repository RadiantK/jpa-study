...
class AuthorRepositoryTest {
    ...
    void manyToManyTest() {
        ...
        Author author1 = givenAuthor("kang");
...
*/
        ...
        author1.addBookAndAuthors(bookAndAuthor1, bookAndAuthor3, bookAndAuthor4);
        author2.addBookAndAuthors(bookAndAuthor2, bookAndAuthor5, bookAndAuthor6);
...
//        System.out.println("books through author: " + authorRepository.findAll().get(0).getBooks());
    ...
    private Book givenBook(String bookName) {
        Book book = new Book();
